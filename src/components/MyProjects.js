        ...
        <div>
            ...
            <div class="projects">
                <section class="card mainproj">        
                    <h2>extracted.</h2>
                    <a href="https://extracted-coffee.herokuapp.com/" target="_blank"><img src="./assets/images/Project4.png" alt="Extracted. Coffee Site"/></a><br />
                    <p>
                ...
                <section class="card">        
                    <h2>Note Taker</h2>
                    <a href="https://newton-notes.herokuapp.com/" target="_blank"><img src="./assets/images/NoteTaker.PNG" alt="Note Taker"/></a><br />
                    <p>
                ...
                <section class="card">        
                    ...
                    <a href="https://inanzo.github.io/NMH_BCHW6/" target="_blank"><img src="./assets/images/Project2.PNG" alt="Weather Dashboard"/></a><br />
                    <p>
                ...
                <section class="card">        
                    <h2>Code Quiz</h2>
                    <a href="https://inanzo.github.io/NMH_BCHW4/" target="_blank"><img src="./assets/images/Project3.PNG" alt="Code Quiz"/></a><br />
                    <p>
                ...
                <section class="card mainproj">        
                    ...
                    <a href="https://snkrfr3sh.github.io/sport_facts/" target="_blank"><img src="./assets/images/Project1.png" alt="NBA Player Stats"/></a><br />
                    <p>
